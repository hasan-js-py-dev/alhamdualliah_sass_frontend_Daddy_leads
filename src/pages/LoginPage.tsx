...
const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login - Daddy Leads | B2B Lead Generation Platform</title>
        <meta name="description" content="Sign in to Daddy Leads to access your B2B data scraping tools, email verification, and lead generation platform." />
      </Helmet>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="Gmail or business email"
